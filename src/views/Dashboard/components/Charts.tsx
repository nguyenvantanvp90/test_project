...
const Charts: React.FC = () => {
  ...
  const fetchReserves = useCallback(async () => {
    ...
    if (soldOpts && soldOpts.chart && soldOpts.xaxis && soldOpts.yaxis && soldOpts.yaxis.title && soldOpts.yaxis.labels) {
      soldOpts.yaxis.title.text = "UNIF Sold";
    ...
    if (mintedOpts && mintedOpts.chart && mintedOpts.xaxis && mintedOpts.yaxis && mintedOpts.yaxis.title && mintedOpts.yaxis.labels ) {
      mintedOpts.yaxis.title.text = "UNIF Minted";
    ...
    if (status === "connected") {
      return (
        <>
          ...
          <Split>
            <Card>
              <CardTitle text="⬇️ UNIF Sold Per Rebase" />
              <Spacer size="sm" />
              <CardContent>
                <Split>
            ...
            <Card>
              <CardTitle text="⬆️ UNIF Minted Per Rebase" />
              <Spacer size="sm" />
              <CardContent>
                <Split>
